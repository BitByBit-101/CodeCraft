...
const MyWorks = () => (
  <div data-scroll data-scroll-speed="0.01" className="min-h-screen w-full bg-[#ff9c4c] overflow-x-hidden relative">
    {/* Heading */}
...
>
        <h1 className="font-eczar text-2xl md:text-3xl text-[#96572a]">
          Weebify<i className="text-base text-[#bd6c32]"> - Anime Discovery/Rating Platform</i>
        </h1>
    ...
    <div className="flex flex-col lg:flex-row items-start gap-5 px-4 md:px-5 mt-5 w-full mb-6">
      ...
      {/* Center card */}
      <AnimatedCard className="w-full lg:w-[32%] bg-[#ffcb9a] rounded-[20px] p-10 flex flex-col justify-center">
        <h1 className="font-eczar text-2xl md:text-3xl text-[#96572a]">
